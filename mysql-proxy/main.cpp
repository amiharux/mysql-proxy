...
public:
  ...
  bridge(asio::io_service& ios, on_data_cb on_client_data = dummy_cb, on_data_cb on_server_data = dummy_cb)
    : client_socket_(ios)
    , server_socket_(ios)
...
public:
  ...
  public:
    acceptor(asio::io_service& io_service,
      ...
      on_data_cb on_client_data = dummy_cb, on_data_cb on_server_data = dummy_cb)
    ...
    bool accept_connections() {
      ...
      try {
        session_ = std::make_shared<bridge>(io_service_, on_client_data_, on_server_data_);
